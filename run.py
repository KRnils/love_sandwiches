...
def get_stock_values():
    """
    Get current stock values from the sheet and print them
    """
    stocksheet = SHEET.worksheet("stock").get_all_values()
    stock_dict = {name : num for name, num in zip(stocksheet[0], stocksheet[-1])}
